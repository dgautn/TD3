...
% el vector contiene los valores temporales de la se�al desde 0s hasta casi 2s con un paso de periodo de muestreo
...
figure('name','Guia 4 ejercicio 6','Units','normalized','Position',[0 0 1 1]); % pantalla completa
...
y = audioplayer (tonos, fs); % reproduce la se�al
playblocking(y); %evita la superposici�n con el segundo audio
