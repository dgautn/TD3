...
ft_pa = (3* fc1 + fc2 - B)/4; % frec transicion del pasa altos
ft_pb = (3* fc2 + fc1 + B)/4; % frec transicion del pasa bajos
...
M = ceil(12/Bt); % cantidad de taps para ventana blackman -> Ancho de lobulo principal = 12/M
...
%axis([0 .5 -150 10]); % limites de los ejes
grid on;
grid minor on;
